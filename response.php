...
<body>
    ...
    <!-- Sub City and New Address forms -->
    <div class="button-container">
        <form action="searchkey-word.php">
            <input type="text" class="input-field sub-heading" placeholder="Please enter institution name to search for" name="keyword" required>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>Copyright © 2024 Addis Address Finder. All Rights Reserved.
        </p>
    </div>

    <!-- JavaScript for Responsive Forms and Accordion -->
    <script>
